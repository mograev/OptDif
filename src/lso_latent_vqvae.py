...
def add_opt_args(parser):
    ...
    bo_group.add_argument("--opt_method", type=str, default="SLSQP", choices=["SLSQP", "L-BFGS-B", "trust-constr"], help="Optimization method to use: 'SLSQP', 'L-BFGS-B' or 'trust-constr'")
