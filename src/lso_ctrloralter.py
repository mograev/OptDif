...
def add_opt_args(parser):
    ...
    bo_group.add_argument("--opt_method", type=str, default="SLSQP", choices=["SLSQP", "trust-constr", "L-BFGS-B"], help="Optimization method to use: 'SLSQP', 'trust-constr' or 'L-BFGS-B'")
