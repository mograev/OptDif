...
if __name__ == "__main__":
    ...
    # Load latent Autoencoder config
    with open(args.latent_autoencoder_config_path, "r") as f:
    ...
    checkpointer = pl.callbacks.ModelCheckpoint(save_last=True, monitor="val_loss")
    ...
    with torch.autograd.set_detect_anomaly(True):
        ...
        # Fit model
        trainer.fit(latent_autoencoder, datamodule)