...
#SBATCH --job-name=sd_gbo                # Job name
#SBATCH --output=logs/lso/sd_gbo_%j.out  # Output log file
#SBATCH --error=logs/lso/sd_gbo_%j.err   # Error log file
