...
#SBATCH --job-name=lso_ctrloralter_gp               # Job name
#SBATCH --output=logs/lso/ctrloralter_gp_01_%j.out  # Output log file
#SBATCH --error=logs/lso/ctrloralter_gp_01_%j.err   # Error log file
...
opt_method="L-BFGS-B" # SLSQP, COBYLA, L-BFGS-B
opt_constraint="GMM"
n_gmm_components=10
sparse_out=True
