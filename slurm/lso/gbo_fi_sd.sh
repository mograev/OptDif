...
#SBATCH --job-name=lso_gbo_fi_sd               # Job name
#SBATCH --output=logs/lso/gbo_fi_sd_01_%j.out  # Output log file
#SBATCH --error=logs/lso/gbo_fi_sd_01_%j.err   # Error log file
...
result_path="results/gbo_fi_sd_01/"
