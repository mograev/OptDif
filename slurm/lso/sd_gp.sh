...
#SBATCH --job-name=sd_gp                # Job name
#SBATCH --output=logs/lso/sd_gp_%j.out  # Output log file
#SBATCH --error=logs/lso/sd_gp_%j.err   # Error log file
...
opt_method="L-BFGS-B" # "L-BFGS-B", "trust-constr", "SLSQP", "COBYLA"
opt_constraint="None" # "GMM", "None"
n_gmm_components=10
sparse_out=True

# Feature Selection
feature_selection="None" # "PCA", "FI", "None"
