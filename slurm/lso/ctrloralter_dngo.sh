...
#SBATCH --output=logs/lso/ctrloralter_dngo_02_%j.out  # Output log file
#SBATCH --error=logs/lso/ctrloralter_dngo_02_%j.err   # Error log file
...
result_path="results/ctrloralter_dngo_02/"
