...
#SBATCH --job-name=ctrloralter_dngo             # Job name
#SBATCH --output=logs/lso/ctrloralter_dngo.out  # Output log file
#SBATCH --error=logs/lso/ctrloralter_dngo.err   # Error log file
...
result_path="results/ctrloralter_dngo/"
