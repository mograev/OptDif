...
#SBATCH --job-name=lso_gp_01              # Job name
#SBATCH --output=logs/lso/gp/01_%j.out    # Output log file
#SBATCH --error=logs/lso/gp/01_%j.err     # Error log file
...
attr_path="data/ffhq/ffhq_smile_scores_scaled.json"
...
n_rand_points=8000
n_best_points=2000
sample_distribution="normal" # "uniform" or "normal"
opt_method="SLSQP"
...
CUDA_VISIBLE_DEVICES=0 python src/lso.py \
    --device $device \
    --seed $seed \
    --img_dir $img_dir \
