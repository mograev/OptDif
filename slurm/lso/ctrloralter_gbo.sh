...
#SBATCH --output=logs/lso/ctrloralter_gbo_02_%j.out  # Output log file
#SBATCH --error=logs/lso/ctrloralter_gbo_02_%j.err   # Error log file
...
result_path="results/ctrloralter_gbo_02/"
sd_vae_path="runwayml/stable-diffusion-v1-5"
...
# Optimization
opt_strategy="GBO" # "GBO", "GP", "DNGO", "GBO_PCA", "GBO_FI"
n_starts=20 #20
