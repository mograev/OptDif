...
#SBATCH --output=logs/lso/ctrloralter_gbo_29_%j.out  # Output log file
#SBATCH --error=logs/lso/ctrloralter_gbo_29_%j.err   # Error log file
...
result_path="results/ctrloralter_gbo_30/"
