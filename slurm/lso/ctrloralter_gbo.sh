...
#SBATCH --job-name=ctrloralter_gbo             # Job name
#SBATCH --output=logs/lso/ctrloralter_gbo.out  # Output log file
#SBATCH --error=logs/lso/ctrloralter_gbo.err   # Error log file
...
result_path="results/ctrloralter_gbo/"
