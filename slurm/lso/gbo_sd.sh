...
#SBATCH --job-name=lso_gbo_sd               # Job name
#SBATCH --output=logs/lso/gbo_sd_01_%j.out  # Output log file
#SBATCH --error=logs/lso/gbo_sd_01_%j.err   # Error log file
