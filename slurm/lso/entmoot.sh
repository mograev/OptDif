...
result_path="results/debug_11/"
sd_vae_path="stabilityai/stable-diffusion-3.5-medium"
latent_model_config_path="models/latent_vqvae/configs/sd35m_to_512d_lpips_disc.yaml"
latent_model_ckpt_path="models/latent_vqvae/version_7/checkpoints/last.ckpt"
...
# Optimization
opt_strategy="ENTMOOT" # "GBO", "GP", "DNGO", "ENTMOOT"
n_starts=10 #20
n_out=5
