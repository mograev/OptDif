...
#SBATCH --job-name=train_latent_linear_ae         # Job name
#SBATCH --output=logs/latent_linear_ae/v1_%j.out  # Output log file
#SBATCH --error=logs/latent_linear_ae/v1_%j.err   # Error log file
...
# Model & Training
model_type="LatentLinearAE"
model_version=4
model_config_path="models/latent_linear_ae/configs/sd35m_to_512d_lpips_disc.yaml"
model_output_dir="models/latent_linear_ae/"
max_epochs=100
