...
#SBATCH --job-name=train_latent_vqvae2_v1       # Job name
#SBATCH --output=logs/latent_vqvae2/v1_%j.out   # Output log file
#SBATCH --error=logs/latent_vqvae2/v1_%j.err    # Error log file
...
# Model & Training
model_type="LatentVQVAE2"
model_version=1_2
model_config_path="models/latent_vqvae2/configs/sd35m_to_2k_lpips_disc.yaml"
model_output_dir="models/latent_vqvae2/"
max_epochs=200
device="cuda"
num_devices=4
